...
public class TestClass_01_Register {
	WebDriver driver;
	...
	@Test
	public void TC_001_RegisterWithEmailAndPassEmpty() {
	...
	@Test
	public void TC_002_RegisterWithEmailAndPassEmpty() {
		String emailErrorMessage = driver.findElement(By.xpath("//div[@id='advice-required-entry-email']")).getText();
		Assert.assertEquals(emailErrorMessage, "This is a required field.");
	...
	@Test
	public void TC_003_RegisterWithEmailAndPassEmpty() {
		String emailErrorMessage = driver.findElement(By.xpath("//div[@id='advice-required-entry-email']")).getText();
		Assert.assertEquals(emailErrorMessage, "This is a required field.");
	...
	@Test
	public void TC_004_RegisterWithEmailAndPassEmpty() {
		String emailErrorMessage = driver.findElement(By.xpath("//div[@id='advice-required-entry-email']")).getText();
		Assert.assertEquals(emailErrorMessage, "This is a required field.");
